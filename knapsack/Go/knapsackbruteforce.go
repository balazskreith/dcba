...
func (solver BruteForceKnapSackSolver) selectMax(actual_weight int,
	...
	// fmt.Println(cantFitInKnapSack)
	// fmt.Println(checkedAllItems)
	...
	fmt.Println("Current Weight: ", current_weight)
	fmt.Println("Actual Weight: ", actual_weight)
	fmt.Println("Weight Limit: ", solver.GetWeightLimit())
	fmt.Println("Current Trace", current_trace)
